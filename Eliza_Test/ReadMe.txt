This folder consist of the necessary functionality to run the program as a console command-line application for testing purposes. It is otherwise similar to the Eliza_main folder, and thus the following information also applies to that folder:
=============
